...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    ...
    <asp:DataList ID="dlFeaturedProducts" runat="server"
            ...
            <ItemTemplate>
                <br />
                <asp:ImageButton ID="imFeat" runat="server" OnClick="imFeat_Click" Width="100px" Height="120px" ImageUrl='<%# Bind("TI_IMAGE_URL","~/Images/{0}") %>'></asp:ImageButton>
                <br />
            </ItemTemplate>
        </asp:DataList>
    <br />
    ...
    <asp:DataList ID="dlLatestProducts" runat="server"
            ...
            <ItemTemplate>
                <br />
                <asp:ImageButton ID="imLat" runat="server" OnClick="imLat_Click" Width="100px" Height="120px" ImageUrl='<%# Bind("TI_IMAGE_URL","~/Images/{0}") %>'></asp:ImageButton>
                <br />
            </ItemTemplate>
        </asp:DataList>
</asp:Content>